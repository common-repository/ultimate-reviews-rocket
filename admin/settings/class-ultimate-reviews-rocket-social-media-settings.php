...
class ultimate_reviews_rocket_Social_Media_Settings extends ultimate_reviews_rocket_Admin {
	...
	public function settings_api_init(){
		...
		add_settings_field(
			'instagram',
			apply_filters( $this->ultimate_reviews_rocket . '-instagram', __( 'Instagram:', $this->ultimate_reviews_rocket ) ),
			array( $this, 'Instagram' ),
			$this->ultimate_reviews_rocket . '-social-media',
			$this->ultimate_reviews_rocket . '-options'
		);
	...
	public function section_heading() {
		...
		?><textarea id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[section-heading]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[section-heading]"  ><?php echo esc_attr($option);?> </textarea>
		<?php
	} // section_heading()
	...
	public function Facebook() {
		...
		?>
		<label for="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[facebook]"></label><input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[facebook]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[facebook]" value="<?php echo esc_url($option);?>" >
		<?php
	} //Facebook()
	...
	public function Instagram() {
		...
		?>
		<label for="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[instagram]"></label><input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[instagram]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[instagram]" value="<?php echo esc_url($option);?>">
		<?php
	} //instagram()
