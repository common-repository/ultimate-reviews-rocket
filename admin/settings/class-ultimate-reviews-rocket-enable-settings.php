...
class ultimate_reviews_rocket_Enable_Settings extends ultimate_reviews_rocket_Admin {
	...
	public function feedback_loop_page_heading() {
		...
		?><textarea id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[feedback-loop-page-heading]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[feedback-loop-page-heading]" rows="4" cols="50"  ><?php echo esc_attr($option);?></textarea>
	...
	public function special_offers_section() {
		...
		?>
		<textarea  id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[special-offers-section]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[special-offers-section]" rows="4" cols="50" ><?php echo esc_attr($option);?></textarea>
	...
	public function feedback_form_submissions() {
		...
		<input type="email" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[feedback-form-submissions]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[feedback-form-submissions]" value="<?php if(empty($option)){trim(bloginfo('admin_email'));}else{ echo esc_attr($option);} ?> "/>
	...
	public function thank_you_page_text_bad() {
		...
		?>
		<textarea id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[thank-you-page-text-bad]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[thank-you-page-text-bad]" rows="4" cols="50" ><?php print($option);?></textarea>
	...
	public function thank_you_page_text_good() {
		...
		?>
		<textarea id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[thank-you-page-text-good]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[thank-you-page-text-good]" rows="4" cols="50" ><?php echo esc_textarea($option);?></textarea>
