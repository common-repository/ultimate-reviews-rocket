...
class ultimate_reviews_rocket_Setting_Settings extends ultimate_reviews_rocket_Admin {
	...
	public function set_the_threshold_rating() {
		...
		<div class="clearfix clsImage">
			<img src="<?php echo plugin_dir_url(dirname( __FILE__ )); ?>/img/threshold.png"/>
		</div>
	...
	public function your_feedback_page() {
		...
		?><div class='urr-pages-wrap'>
			<select id="<?php echo esc_attr($this->ultimate_reviews_rocket ); ?>_options[urr_your_feedback_page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_your_feedback_page]"> 
			...
			<a href="<?php echo esc_url(get_permalink($urr_ratings_page_id)); ?>" target="_blank"><small>View Page</small></a>
			</div>
			<div class='urr-pages-wrap'>
		<input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[your-feedback-page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[your-feedback-page]" readonly value="[urr-feedback]"/>
	...
	public function ratings_page_heading() {
		...
		?>
		<input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[ratings-page-heading]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[ratings-page-heading]" value="<?php echo esc_attr($option);?>" >
		<?php
	...
	public function ratings_page() {
		...
		?><div class='urr-pages-wrap'>			
			...
			<select id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_main_ratings_page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_main_ratings_page]"> 
		...
		<div class='urr-pages-wrap'>
			<input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[ratings-page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[ratings-page]" readonly value="[urr-review]" >
			[<a href="" onclick="return false;" class="click-to-copy"><small>Copy to clipboard</small></a>]
		</div>
		<?php
	} //ratings_page()
	 ...
	 */
	 public function your_feedback_thank_you_page() {
		...
		<div class='urr-pages-wrap'>			
			<select id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_feedback_thank_page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_feedback_thank_page]">
			...
			<a href="<?php echo esc_html(get_permalink($urr_ratings_page_id)); ?>" target="_blank"><small>View Page</small></a>
			</div>

			<div class='urr-pages-wrap'>
				<input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[your-feedback-thank-you-page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[your-feedback-thank-you-page]" readonly value="[urr-feedback-thank-you]" >
				[<a href="" onclick="return false;" class="click-to-copy"><small>Copy to clipboard</small></a>]
			</div>
		<?php
	...
	public function social_media_reviews_page() {
		...
		?><div class='urr-pages-wrap'>		
			<select id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_social_media_page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[urr_social_media_page]"> 
				<option disabled="disabled" value=""><?php echo esc_attr( __( 'Select a page' ) ); ?></option> 
				<?php
				foreach ( $pages as $page ) {
					$pagekey = '<option value="' . $page->ID . '" ';
		...
		<div class='urr-pages-wrap'>
			<input type="text" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[social-media-reviews-page]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[social-media-reviews-page]" readonly value="[urr-social-media-reviews]" >
			[<a href="" onclick="return false;" class="click-to-copy"><small>Copy to clipboard</small></a>]
		</div>
		<?php
	} //social_account_link()	
	...
	public function enable_a_feedback_form() {
		...
		?>
		<input type="checkbox" id="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[enable-a-feedback-form]" name="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[enable-a-feedback-form]" value="1" <?php checked('1', $option); ?> ><label for="<?php echo esc_attr($this->ultimate_reviews_rocket); ?>_options[enable-a-feedback-form]"><strong>Enable a feedback form on the Social Media Reviews page</strong></label>
		<?php
