							...
							<div id="normal-sortables" class="meta-box-sortables ui-sortable">
								<div id="itsec_get_started" class="postbox ">
									<div class="inside">
										...
										$tick_count3 = 0;
										if( !empty($option_social_media['facebook']) || !empty($option_social_media['instagram']) ) {
										...
										<ul class="urr-gen-list">
											...
											<li> <?php printf( esc_attr__( '%s' ), $feedback_true ); ?> <span> Configure the <a href="<?php esc_url(get_admin_url(null, 'options-general.php'));?>?page=ultimate_reviews_rocket&tab=feedback_loop"><strong>Feedback Loop</strong></a> settings or click <a href="<?php esc_url(get_admin_url(null, 'options-general.php')); ?>?page=ultimate_reviews_rocket&tab=feedback_loop"><strong>here</strong></a>.</span></li>

											<li> <?php printf( esc_attr__( '%s' ), $good_rating_true ); ?> <span> Configure the <a href="<?php esc_url(get_admin_url(null, 'options-general.php'));?>?page=ultimate_reviews_rocket&tab=social_media"><strong>Social Media</strong></a> settings or click <a href="<?php esc_url(get_admin_url(null, 'options-general.php')); ?>?page=ultimate_reviews_rocket&tab=social_media"><strong>here</strong></a>.</span></li>

											<li> <?php printf( esc_attr__( '%s' ), $settings_true ); ?> <span> Configure the <a href="<?php esc_url(get_admin_url(null, 'options-general.php')); ?>?page=ultimate_reviews_rocket&tab=settings"><strong>Settings</strong></a> or click <a href="<?php esc_url(get_admin_url(null, 'options-general.php')); ?>?page=ultimate_reviews_rocket&tab=settings"><strong>here</strong></a>.</span></li>				
											...
											<li> <?php if($tick_count3 == 1 && $tick_count1 == 1 && $tick_count2 == 1) {
												...
												echo "<span><strong> You are done! </strong>Here is the <a href=".esc_url(get_permalink($urr_ratings_page_id))." target='_blank'><strong>page</strong></a> to send people to.!</span>";
											} else {
										...
										<table class="wp-list-table widefat fixed striped urr_form_entries" id="urr-form-entries">
											...
											foreach( $urr_search_results as $urr_result )  {
												...
												<tr>
													...
													<td><?php _e(stripslashes(nl2br($urr_result->urr_comments))); ?></td>
