...
class ultimate_reviews_rocket {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'URR_admin_enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'URR_admin_enqueue_scripts' );
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'URR_public_enqueue_styles' );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'URR_public_enqueue_scripts' );
		...
		$this->loader->add_action( 'wp_head', $plugin_public, 'URR_head_wp_enqueue_scripts');
	}
